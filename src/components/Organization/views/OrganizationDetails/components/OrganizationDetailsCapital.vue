<template>
    ...
    >
        <template slot-scope="props">
            ...
            <b-table-column
                field="props.row.number"
                :label="$t('EVENTS_DETAILS.NUMBERS_SHARES')"
            >
                {{ getNumberShares(props.row.number) }}
            </b-table-column>
...
<script lang="ts">
    ...
    export default class OrganizationDetailsCapital extends Vue {
        $refs!: {
            table: any
        };
