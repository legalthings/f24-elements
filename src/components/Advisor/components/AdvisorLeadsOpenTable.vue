    ...
    >
        ...
        >
            <article>
                ...
                <div class="buttons">
                    <p>
                        {{ $t('ADVISOR.LOST_OR_WON') }}
                    </p>
                    <b-button
                        type="is-danger is-padding-small has-icon"
                        rounded
                        outlined
                        @click="rate('lost', row)"
                    >
                    ...
                    <b-button
                        type="is-success is-padding-small has-icon"
                        rounded
                        outlined
                        @click="rate('won', row)"
                    >
...
<script lang="ts">
    ...
    export default class AdvisorLeadsOpenTable extends Vue {
        $refs!: {
            table: any
        };
